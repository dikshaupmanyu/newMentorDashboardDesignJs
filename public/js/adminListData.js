...
const docRefUserList = db.collection("/basilPrivateGroup/Production/groupMembersInfo/");
const tasksDOMUserlist = document.getElementById("tasksuserlist");
const tasksDOMTotalUserlist = document.getElementById("tasksuserlisttotal");
...
const docRefreply = db.collection("/basilPrivateGroup/Production/messages/"+id+"/replies/");
...
function handleDeleteReply(obj1,obj2) {
    ...
    const docRefreply = db.collection("/basilPrivateGroup/Production/messages/"+obj2+"/replies/");
    var txt;
          if (confirm("Are you sure you want to delete this chat ?")) {
             return docRefreply
            .doc(obj1)
...
if (task.userId === loggedInVal) {
  ...
  elem.setAttribute("class", "admin clearfix");
    ...
    if(task.messageType === "photo"){
      ...
      elem.innerHTML = '<span class="chat-img right clearfix mx-2"><img src="'+ task.profileImageUrl +'" alt="Admin" class="img-circle w-100"/></span><div class="chat-body clearfix"><div class="header clearfix"><small class="left text-muted"><span class="glyphicon glyphicon-time"></span>' + task.createdDate + '</small><strong class="right primary-font" class="fullName">'+ task.userName +'</strong></div><p class="message"><img src="'+ task.message +'" class="img-responsive w-100"/></p></div>'
  ...
  elem.setAttribute("class", "agent clearfix");
    ...
    if(task.messageType === "photo"){
        ...
        elem.innerHTML = '<span class="chat-img left clearfix mx-2"><img src="'+ task.profileImageUrl +'" alt="Admin" class="img-circle w-100"/></span><div class="chat-body clearfix"><div class="header clearfix"><small class="right text-muted"><span class="glyphicon glyphicon-time"></span>' + task.createdDate + '</small><strong class="primary-font" class="fullName">'+ task.userName +'</strong></div><p class="message"><img src="'+ task.message +'" class="img-responsive w-100"/></p></div>'
...
function fetchTasks() {
   ...
   docRef.orderBy("createdDate", "asc").onSnapshot(function(snapshot) {
      snapshot.docChanges().forEach(function(change) {
          ...
          const docRefreply = db.collection("/basilPrivateGroup/Production/messages/"+change.doc.id+"/replies/");
   ...
   docRefUserList.onSnapshot(function(snapshot) {
      ...
      snapshot.docChanges().forEach(function(change) {
           ...
           if (change.type === "added") {
              ...
              var tasks = change.doc.data();

              // var loggedInVal = user_id.value;
              // var loggedInName = user_nickname.value;
              const elems = document.createElement("li");
              elems.id = tasks.userId;
              elems.innerHTML = reviewTemplateUserList(tasks);
              tasksDOMUserlist.append(elems);
              // alert(elems);
              ...
              const elemCount = document.createElement("li");
              elemCount.innerHTML = "Members : " + snapshot.docChanges().length;
              tasksDOMTotalUserlist.append(elemCount);

       // var tasksDOMTotalUserlist = snapshot.docChanges().length;
       // alert(tasksDOMTotalUserlist);
...
// alert(uniqueId);
       ...
       <div class="Overlay">
           <div class="Overlay-1">
             ...
             <div class="header clearfix">
                 <small class="left text-muted" style = "display:inline-block;"><span class="glyphicon glyphicon-time"><div id="finalValn${uniqueId}"><a onClick='replypopup(this.id)' id='${uniqueId}' role="button" data-toggle="modal" data-target="#exampleModalCenter${uniqueId}">  Replies : <span id="sizedatan${uniqueId}"></span></a> </div></span>${stripped1}</small>
               
                 <strong class="right primary-font" class='fullName'>${userName}</strong>
             </div>
             <p class='message' id="${uniqueId}">
                 <span id='textMessage${uniqueId}'>${message} <svg class="Chevron" onclick="TogglePopup(this.id)" id="${uniqueId}"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                 width="24" height="24"
                 viewBox="0 0 172 172"
     ...
     `
      ...
      <li class="admin clearfix">
              ...
              <div class="Overlay">
                  ...
                  <div class="header clearfix">
                      <small class="left text-muted"><span class="glyphicon glyphicon-time"><div id="finalValn${uniqueId}"><a onClick='replypopup(this.id)' id='${uniqueId}' role="button" data-toggle="modal" data-target="#exampleModalCenter${uniqueId}"> Replies : <span id="sizedatan${uniqueId}"></span></a> </div></span>${stripped1}</small>
 ...
 <div class="modal fade" id="exampleModalCenter${uniqueId}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle${uniqueId}" aria-hidden="true" data-backdrop="static" data-keyboard="false">
     ...
     <div class="Overlay">
         ...
         <p class='message'><a href="${message}" target="_blank">  <svg class="Chevron" onclick="TogglePopup(this.id)" id="${uniqueId}"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
         width="24" height="24"
         viewBox="0 0 172 172"
         style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M124.36689,70.61689l-35.83333,35.83333c-0.67183,0.67205 -1.58315,1.04963 -2.53342,1.04963c-0.95026,0 -1.86159,-0.37757 -2.53342,-1.04963l-35.83333,-35.83333c-1.35798,-1.40602 -1.33856,-3.64097 0.04365,-5.02318c1.38221,-1.38221 3.61716,-1.40163 5.02318,-0.04365l33.29977,33.29977l33.29977,-33.29985c1.40602,-1.35798 3.64097,-1.33856 5.02318,0.04365c1.38221,1.38221 1.40163,3.61716 0.04365,5.02318z"></path></g></g></svg>
  ...
  if(messageType == "text"){
   ...
   <li class="agent clearfix">
     ...
     <div class="overlay">
         ...
         <div class="header clearfix">
             <small class="right text-muted" style="color: #000"><span class="glyphicon glyphicon-time"><div id="finalValn${uniqueId}"><a onClick='replypopup(this.id)' id='${uniqueId}' role="button" data-toggle="modal" data-target="#exampleModalCenter${uniqueId}"> Replies : <span id="sizedatan${uniqueId}"></span></a> </div></span>${stripped1} </small>
             <strong class="primary-font" class='fullName' style="color: #000">${userName}</strong>
         </div>
         <p class='message' style="color: #000 !important" >

         <span id="textMessage${uniqueId}">
                   ${message} <img class="chevron" onclick="togglePopup(this.id)" id="${uniqueId}" src="https://img.icons8.com/external-royyan-wijaya-detailed-outline-royyan-wijaya/24/000000/external-chevron-arrow-line-royyan-wijaya-detailed-outline-royyan-wijaya.png"/>
         </span>
         ...
         <div class="modal fade" id="exampleModalCenter${uniqueId}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle${uniqueId}" aria-hidden="true" data-backdrop="static" data-keyboard="false">
           ...
           <div class="modal fade" id="exampleModalCenterFlag${uniqueId}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
               ...
               <div class="modal-content">
                 <div>
                  ...
                  <div class="Flag">
                     ...
                     <a><div class="flag" onClick='flagData(this.id ,"Offensive")' id='${uniqueId}' value="Offensive">Offensive</div></a>
                     <a><div class="flag" onClick='flagData(this.id ,"Irrevalent")' id='${uniqueId}' value="Irrevalent">Irrelaavent</div></a>
                     <a><div class="flag" onClick='flagData(this.id ,"Other")' id='${uniqueId}' value="Other">Other</div></a>
     ...
     <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
       <div class="overlay">
         ...
         <div class="header clearfix">
          ...
          <p class='message'><a href="${message}" target="_blank"> <img class="chevron" onclick="togglePopup(this.id)" id="${uniqueId}" src=" https://img.icons8.com/external-royyan-wijaya-detailed-outline-royyan-wijaya/24/000000/external-chevron-arrow-line-royyan-wijaya-detailed-outline-royyan-wijaya.png" />
             <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
             width="25" height="25"
             viewBox="0 0 172 172"
             style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ecf0f1"><path d="M44.79167,14.33333c-8.89025,0 -16.125,7.23475 -16.125,16.125v111.08333c0,8.89025 7.23475,16.125 16.125,16.125h82.41667c8.89025,0 16.125,-7.23475 16.125,-16.125v-69.875h-41.20833c-8.89025,0 -16.125,-7.23475 -16.125,-16.125v-41.20833zM96.75,17.48275v38.05892c0,2.96342 2.41158,5.375 5.375,5.375h38.05892z"></path></g></g></svg>
   ...
   <li class="agent clearfix">
     ...
     <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
       ...
       <div class="overlay">
         ...
         <p class='message'><a href="${message}" target="_blank" style="color:black"> <img class="chevron" onclick="togglePopup(this.id)" id="${uniqueId}" src=" https://img.icons8.com/external-royyan-wijaya-detailed-outline-royyan-wijaya/24/000000/external-chevron-arrow-line-royyan-wijaya-detailed-outline-royyan-wijaya.png" />
         <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
         width="25" height="25"
         viewBox="0 0 172 172"
...
<div class="Overlay">
  <div class="Overlay-1">
    ...
    <div class="header clearfix">
      ...
      <p class='message'><img src="${message}" class="img-responsive" style="width:150px;"/></p>
</div>
</li>
`
